 ...
 */
 ...
 #include "mlkem-native/mlkem/sys.h"

 #include "mlkem-native/mlkem/compress.c"
 #include "mlkem-native/mlkem/debug.c"
 #include "mlkem-native/mlkem/indcpa.c"
 #include "mlkem-native/mlkem/kem.c"
 #include "mlkem-native/mlkem/poly.c"
 #include "mlkem-native/mlkem/poly_k.c"
 #include "mlkem-native/mlkem/sampling.c"
 #include "mlkem-native/mlkem/verify.c"
 
 #if !defined(MLK_CONFIG_MONOBUILD_CUSTOM_FIPS202)
 #include "mlkem-native/mlkem/fips202/fips202.c"
 #include "mlkem-native/mlkem/fips202/fips202x4.c"
 #include "mlkem-native/mlkem/fips202/keccakf1600.c"
 #endif
 
 #if defined(MLK_CONFIG_MONOBUILD_WITH_NATIVE_ARITH)
 #if defined(MLK_SYS_AARCH64)
 #include "mlkem-native/mlkem/native/aarch64/src/aarch64_zetas.c"
 #include "mlkem-native/mlkem/native/aarch64/src/rej_uniform_table.c"
 #endif
 #if defined(MLK_SYS_X86_64)
 #include "mlkem-native/mlkem/native/x86_64/src/basemul.c"
 #include "mlkem-native/mlkem/native/x86_64/src/compress_avx2.c"
 #include "mlkem-native/mlkem/native/x86_64/src/consts.c"
 #include "mlkem-native/mlkem/native/x86_64/src/rej_uniform_avx2.c"
 #include "mlkem-native/mlkem/native/x86_64/src/rej_uniform_table.c"
 #endif /* MLK_SYS_X86_64 */
 #endif /* MLK_CONFIG_MONOBUILD_WITH_NATIVE_ARITH */
 
 #if defined(MLK_CONFIG_MONOBUILD_WITH_NATIVE_FIPS202)
 #if defined(MLK_SYS_AARCH64)
 #include "mlkem-native/mlkem/fips202/native/aarch64/src/keccakf1600_round_constants.c"
 #endif
 #if defined(MLK_SYS_X86_64)
 #include "mlkem-native/mlkem/fips202/native/x86_64/src/KeccakP_1600_times4_SIMD256.c"
 #endif
